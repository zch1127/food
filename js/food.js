    ...
    for (var i in persons) {
      ...
      */
      ...
      if(ab>1 && ab<6 && footVal==1){
        ...
        $("#firstImg").html("");
        $("#firstImg").append('<img src="image/20210321/zaocan.jpg" width="1242" height="1242" alt="">');
        //获取早餐相关数据
        for (var prop in obj) {
          if(prop == str_attr){
        ...
        $("#firstImg").html("");
        $("#firstImg").append('<img src="image/20210321/wucan.jpg" width="1242" height="1242" alt="">');
        //获取午餐相关数据
        for (var prop in obj) {
          if(prop == str_attr){
              $('#J_AttrUL').append("<li>"+obj[str_attr]+"</li>");
          ...
          $("#firstImg").html("");
          $("#firstImg").append('<img src="image/20210321/wudian.jpg" width="1242" height="1242" alt="">');
          //获取午餐相关数据
          for (var prop in obj) {
            if(prop == str_attr){
                $('#J_AttrUL').append("<li>"+obj[str_attr]+"</li>");
        ...
        $("#firstImg").html("");
        $("#firstImg").append('<img src="image/20210321/wancan.jpg" width="1242" height="1242" alt="">');
        //获取晚餐相关数据
        for (var prop in obj) {
          if(prop == str_attr){
              $('#J_AttrUL').append("<li>"+obj[str_attr]+"</li>");
